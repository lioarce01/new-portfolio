...
import thumbCryptoYield from "../../assets/images/thumbCryptoYield.png"
  ...
  return (
    <div className="mb-4 mx-1">
      <div className="bg-[#141414] max-w-sm rounded overflow-hidden shadow-lg border border-[#3b3b3b] dark:bg-[#FFFAF0] dark:border-[#FFFAF0]">
        <img className="w-full" src={thumbCryptoYield} alt="Crypto Tracker" />
        <div className="px-2">
          ...
          <p className="text-gray-300 font-light text-base dark:text-[#141414]">
            Crypto Website Frontend with ReactJS and NextUI
          </p>
        </div>
        <div className="py-4 px-2 items-center justify-start flex">
          <a
            href="https://github.com/lioarce01/crypto-project-react-app"
          ...
          <a
            href="https://crypto-project-react-app.vercel.app"
          ...
          <div className="justify-end flex items-end mx-4 text-gray-300">
            <p className="mx-3 rounded-xl p-1 hover:bg-gray-300 transition duration-300 hover:text-[#141414] md:mx-[2px] dark:text-[#141414] dark:bg-[#fcf9df]">
              #ReactJs
            </p>
            <p className="mx-3 rounded-xl p-1 hover:bg-gray-300 transition duration-300 hover:text-[#141414] md:mx-[2px] dark:text-[#141414] dark:bg-[#fcf9df]">
              #NextUI

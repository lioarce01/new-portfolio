...
import thumbPizza from "../../assets/images/thumbPizza.png"
  ...
  return (
    <div className="mb-4 mx-1">
      <div className="bg-[#141414] max-w-sm rounded overflow-hidden shadow-lg border border-[#3b3b3b] dark:bg-[#FFFAF0] dark:border-[#FFFAF0]">
        <img className="w-full" src={thumbPizza} alt="Crypto Tracker" />
        <div className="px-2">
          ...
          <p className="text-gray-300 font-light text-base dark:text-[#141414]">
            Pizza Restaurant Website with ReactJS and Styled Components.
          </p>
        </div>
        <div className="py-4 px-2 items-center justify-start flex">
          <a
            href="https://github.com/lioarce01/pizza-restaurant-react-app"
          ...
          <a
            href="https://lioarce-restaurant-react-app.vercel.app"

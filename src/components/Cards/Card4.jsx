...
import thumbTwitch from "../../assets/images/thumbTwitch.png"
  ...
  return (
    <div className="mb-4 mx-1">
      <div className="bg-[#141414] max-w-sm rounded overflow-hidden shadow-lg border border-[#3b3b3b] dark:bg-[#FFFAF0] dark:border-[#FFFAF0]">
        <img className="w-full" src={thumbTwitch} alt="Crypto Tracker" />
        <div className="px-2">
          ...
          <p className="text-gray-300 font-light text-base dark:text-[#141414]">
            Twitch Website Clone With NextJS, and TailwindCSS.
          </p>
        </div>
        <div className="py-4 px-2 items-center justify-start flex">
          <a
            href="https://github.com/lioarce01/twitch-next-app"
          ...
          <a
            href="https://twitch-next-app.vercel.app"
